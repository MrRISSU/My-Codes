...
// GSM client for MQTT
TinyGsmClient GsmClient(gsm_modem, 0);
SSLClientESP32 GsmClientSecure(&GsmClient);
//////////////////////////////////////////
...
static String gsmLocParamLines[GSM_MAX_SERVING_CELLS];
...
{   
    ...
    SetPowerPin();
    strncpy(simInfo.selectedApn, GSM_DEFAULT_APN, sizeof(simInfo.selectedApn));
